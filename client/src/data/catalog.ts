...
export const asset = {
  hero: "/manus-storage/vivi-moonlit-library-hero_bcde9c71.jpg",
  tarot: "/manus-storage/vivi-tarot-journal_22628c06.jpg",
  energy: "/manus-storage/vivi-energy-ritual_71454278.jpg",
  style: "/manus-storage/vivi-style-luck_60ef9fd5.jpg",
  seal: "/manus-storage/vivi-meixin-academy-moon-star-emblem_e11a64e3.png",
  viviPortrait: "/manus-storage/JZ6_7995_04adc834.jpg",
  originalLogo: "/manus-storage/vivi-original-logo_2f195486.png",
  caseGrowth: "/manus-storage/47_10301830.png",
  caseBeforeAfter: "/manus-storage/49_eb5a7fc1.png",
...
export const tools: FreeTool[] = [
  {
    ...
    format: "PDF 練習表",
    pages: "3 頁可書寫練習",
    downloadUrl: "/manus-storage/repeating-signals-workbook_c241c5e0.pdf",
  ...
  },
  {
    ...
    format: "PDF 定位工作表",
    pages: "5 頁策略練習",
    downloadUrl: "/manus-storage/healer-positioning-workbook_69307bed.pdf",
  ...
  },
  {
    ...
    format: "PDF 意圖穿搭卡",
    pages: "5 頁造型練習",
    downloadUrl: "/manus-storage/intentional-style-card_99cd139a.pdf",
...
export const products: Product[] = [
  ...
  },
  {
    ...
    detail: "數位音檔、引導卡與晚間紀錄頁；付款完成後寄送下載連結。",
    image: asset.energy,
    badge: "晚間練習",
  },
  {
