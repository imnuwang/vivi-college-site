...
import { ArrowRight, Bookmark, Check, Copy, Heart, Play, RotateCcw, Search, Sparkles, TimerReset, WandSparkles, X } from "lucide-react";
...
export default function EnergyCards() {
  ...
  return <div className="energy-cards-page">
    ...
    <main className="ec-shell">
      ...
      <section className="ec-take-home"><div><SectionEyebrow className="text-[#a9874d]">KEEP EXPLORING FOR FREE</SectionEyebrow><h2>這 12 張卡，<br />已經完整開放給你使用。</h2><p>你可以收藏常用卡、複製出場指令，或在下一次需要開口前，再回來跑完三分鐘。想從別的卡點開始，也可以看看美心學苑的免費資源庫。</p></div><div className="ec-take-home-action"><span>免費內容 · 不需付款</span><a href="/shop"><Sparkles size={16} />探索更多免費資源</a><small>七日覺察、意圖穿搭、晚間回穩與內容承接地圖，都可以直接使用。</small></div></section>
