...
export default function Tools() {
  return (
    <>
      ...
      <section className="section-space"><div className="site-shell tarot-promo"><div><SectionEyebrow>NEW · A SMALL DAILY RITUAL</SectionEyebrow><h2 className="display-heading mt-4">不想下載任何東西時，<br />也可以先抽一張牌。</h2><p className="mt-5 max-w-xl leading-8 text-[#536158]">塔羅一日一牌會把抽到的訊號轉成一個書寫問題與 10 分鐘行動。它只是一段自我覺察，不替你預言或決定未來。</p></div><Link href="/tarot-daily" className="vivi-button vivi-button-dark">前往塔羅一日一牌 <ArrowRight className="size-4" /></Link></div></section>
      ...
      <section className="section-space pt-0"><div className="site-shell tarot-promo border-[#d9e3d8] bg-[#f5f8f3]"><div><SectionEyebrow>THE FREE LIBRARY · NEW PRACTICES</SectionEyebrow><h2 className="display-heading mt-4">想更深入一點時，<br />這裡還有四份可直接填寫的練習。</h2><p className="mt-5 max-w-xl leading-8 text-[#536158]">從七日覺察、意圖穿搭、晚間回穩到內容承接地圖，每一份都不需付款、不需下載，也不需要先留下 Email。</p></div><Link href="/shop" className="vivi-button vivi-button-dark">打開免費資源庫 <ArrowRight className="size-4" /></Link></div></section>
